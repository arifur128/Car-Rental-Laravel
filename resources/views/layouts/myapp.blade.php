            ...
            <div class="pt-10 mx-auto max-w-screen-xl relative">
                    ...
                    <div class="grid grid-cols-3 gap-8 ">
                        <div>
                            ...
                            <ul class=" text-gray-400">
                                <li class="mb-4">
                                    <a href="https://www.linkedin.com/in/arifur198/" target='_blank'="hover:underline">Arifur</a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/in/arifur198/" target='_blank'
                                        class="hover:underline">ArifurDevs</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul class="text-gray-400">
                                <li class="mb-4">
                                    <a href="https://github.com/arifur128" class="hover:underline "
                                        target='_blank'>Github</a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/in/arifur198/" class="hover:underline"
                ...
                <div class="sm:flex sm:items-center sm:justify-between md:ms-0 pb-4  ms-32">
                    <span class="text-sm sm:text-center text-gray-400 md:ms-0 -ms-8">© 2025 <a
                            ...
                            class="hover:underline">Arifur.dev™</a>. All Rights Reserved.
                    </span>
                    <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="https://github.com/arifur12877" target='_blank'
                        ...
                        <a href="https://twitter.com/arifur001" target='_blank'
                            class="text-gray-500 hover:text-white">
                            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path
