            ...
            <main class="h-full overflow-y-auto">
                <div class="container px-6 mx-auto grid mb-32 ">
                    <div class="flex items-center justify-between">
                        ...
                        {{-- NEW: Quick link to Payment Reports --}}
                        <a href="{{ route('admin.reports.payments') }}"
                           class="inline-flex items-center gap-2 px-4 py-2 my-6 text-white rounded-lg shadow bg-pr-400 hover:bg-pr-500">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M3 3h18v2H3V3zm3 6h12v2H6V9zm-3 6h18v2H3v-2z"/>
                            </svg>
                            View Reports
                        </a>
                    </div>
                    ...
                    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        {{-- NEW: Payment Reports Card --}}
                        <a href="{{ route('admin.reports.payments') }}">
                            <div class="flex items-center p-4 bg-white rounded-lg shadow-xs hover:bg-pr-200">
                                <div class="p-3 mr-4 bg-pr-400 rounded-full">
                                    <svg style="fill:#fff" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24">
                                        <path d="M3 3h18v2H3V3zm2 6h14v2H5V9zm-2 6h18v2H3v-2zm2 6h14v2H5v-2z"/>
                                    </svg>
                                </div>
                                <div>
                                    <p class="text-lg font-medium text-pr-400">
